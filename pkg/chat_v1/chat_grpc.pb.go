// Code generated by protoc-gen-go-auth. DO NOT EDIT.
// versions:
// - protoc-gen-go-auth v1.4.0
// - protoc             v4.24.4
// source: chat.proto
...
// is compatible with the auth package it is being compiled against.
...
// It's only intended for direct use with auth.RegisterService,
